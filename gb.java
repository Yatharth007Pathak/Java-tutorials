...
public class gb {: This line defines a public class named gb. In Java, every application must have at least one class definition.
...
for (int i = rows; i >= 1; i--) {: This is the outer for loop, which controls the number of rows to be printed in reverse order. 
